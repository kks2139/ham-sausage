...
export const catCharacters = [
  {
    ...
    dialog: {
      ...
      punch: "이건 10원짜리 하나 안 틀린 종로의 매운맛이다!",
  ...
  },
  {
    ...
    dialog: {
      ...
      lose: "형사가 운이 없으면 죽는 거야... 세상이 다 그런 거지.",
      taunt: "근데 너, 정마담하고는 무슨 관계냐? 걔가 참 무서운 여자거든.",
      seduce: "나랑 같이 곽철용이 죽인 놈 찾으러 가자. 너 복비는 챙겨줄게.",
      punch: "이게 바로... 아주 처참한 주먹 맛이라는 거야.",
